...
@section('title', 'Data User Kasir')

@section('content')

<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="fas fa-users me-2"></i> Data User Kasir</h2>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tr>
                    ...
                    <td>{{ $u->username }}</td>
                    <td>
                        <span class="badge px-3 py-2" style="background: #1abc9c; font-size: 0.8rem;">
                ...
                <tr>
                    <td colspan="6" class="text-center py-5">
                        ...
                        <p class="text-muted mb-0">Belum ada data user kasir</p>
                        <a href="{{ route('admin.users.create') }}" class="btn btn-sm btn-primary mt-3">
                            <i class="fas fa-plus me-1"></i> Tambah Kasir Sekarang
                        </a>
                    </td>
                </tr>
                @endforelse
...
document.querySelectorAll('.btn-hapus').forEach(function(btn) {
    btn.addEventListener('click', function() {
        ...
        Swal.fire({
            icon: 'warning',
            title: 'Hapus User Kasir?',
            html: 'User Kasir <strong>' + nama + '</strong> akan dihapus permanen!',
